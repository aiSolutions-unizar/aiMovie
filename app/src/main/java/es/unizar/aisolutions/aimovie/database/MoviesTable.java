...
public class MoviesTable {
    ...
    public static final Set<String> AVAILABLE_COLUMNS = new HashSet<>(Arrays.asList(new String[]{
            PRIMARY_KEY, COLUMN_TITLE, COLUMN_YEAR, COLUMN_RATED, COLUMN_RELEASED, COLUMN_RUNTIME,
            COLUMN_DIRECTOR, COLUMN_WRITER, COLUMN_PLOT, COLUMN_LANGUAGE, COLUMN_COUNTRY, COLUMN_AWARDS,
            COLUMN_POSTER, COLUMN_METASCORE, COLUMN_IMDB_RATING, COLUMN_IMDB_VOTES, COLUMN_IMDB_ID,
            COLUMN_STOCK, COLUMN_RENTED
    }));
